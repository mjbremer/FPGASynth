...
module soc_mm_interconnect_0 (
		...
		input  wire        sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset, // sample_clk_inclk_interface_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  amp_s1_address,                                               //                                                 amp_s1.address
		output wire        amp_s1_write,                                                 //                                                       .write
		input  wire [31:0] amp_s1_readdata,                                              //                                                       .readdata
		output wire [31:0] amp_s1_writedata,                                             //                                                       .writedata
		output wire        amp_s1_chipselect,                                            //                                                       .chipselect
		output wire [1:0]  freq_s1_address,                                              //                                                freq_s1.address
		output wire        freq_s1_write,                                                //                                                       .write
		input  wire [31:0] freq_s1_readdata,                                             //                                                       .readdata
		output wire [31:0] freq_s1_writedata,                                            //                                                       .writedata
		output wire        freq_s1_chipselect,                                           //                                                       .chipselect
		...
		output wire [1:0]  sample_clk_pll_slave_address,                                 //                                   sample_clk_pll_slave.address
		output wire        sample_clk_pll_slave_write,                                   //                                                       .write
		output wire        sample_clk_pll_slave_read,                                    //                                                       .read
		input  wire [31:0] sample_clk_pll_slave_readdata,                                //                                                       .readdata
		output wire [31:0] sample_clk_pll_slave_writedata,                               //                                                       .writedata
	...
	wire    [9:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire   [31:0] sample_clk_pll_slave_agent_m0_readdata;                                             // sample_clk_pll_slave_translator:uav_readdata -> sample_clk_pll_slave_agent:m0_readdata
	wire          sample_clk_pll_slave_agent_m0_waitrequest;                                          // sample_clk_pll_slave_translator:uav_waitrequest -> sample_clk_pll_slave_agent:m0_waitrequest
	wire          sample_clk_pll_slave_agent_m0_debugaccess;                                          // sample_clk_pll_slave_agent:m0_debugaccess -> sample_clk_pll_slave_translator:uav_debugaccess
	wire   [28:0] sample_clk_pll_slave_agent_m0_address;                                              // sample_clk_pll_slave_agent:m0_address -> sample_clk_pll_slave_translator:uav_address
	wire    [3:0] sample_clk_pll_slave_agent_m0_byteenable;                                           // sample_clk_pll_slave_agent:m0_byteenable -> sample_clk_pll_slave_translator:uav_byteenable
	wire          sample_clk_pll_slave_agent_m0_read;                                                 // sample_clk_pll_slave_agent:m0_read -> sample_clk_pll_slave_translator:uav_read
	wire          sample_clk_pll_slave_agent_m0_readdatavalid;                                        // sample_clk_pll_slave_translator:uav_readdatavalid -> sample_clk_pll_slave_agent:m0_readdatavalid
	wire          sample_clk_pll_slave_agent_m0_lock;                                                 // sample_clk_pll_slave_agent:m0_lock -> sample_clk_pll_slave_translator:uav_lock
	wire   [31:0] sample_clk_pll_slave_agent_m0_writedata;                                            // sample_clk_pll_slave_agent:m0_writedata -> sample_clk_pll_slave_translator:uav_writedata
	wire          sample_clk_pll_slave_agent_m0_write;                                                // sample_clk_pll_slave_agent:m0_write -> sample_clk_pll_slave_translator:uav_write
	wire    [2:0] sample_clk_pll_slave_agent_m0_burstcount;                                           // sample_clk_pll_slave_agent:m0_burstcount -> sample_clk_pll_slave_translator:uav_burstcount
	wire          sample_clk_pll_slave_agent_rf_source_valid;                                         // sample_clk_pll_slave_agent:rf_source_valid -> sample_clk_pll_slave_agent_rsp_fifo:in_valid
	wire  [107:0] sample_clk_pll_slave_agent_rf_source_data;                                          // sample_clk_pll_slave_agent:rf_source_data -> sample_clk_pll_slave_agent_rsp_fifo:in_data
	wire          sample_clk_pll_slave_agent_rf_source_ready;                                         // sample_clk_pll_slave_agent_rsp_fifo:in_ready -> sample_clk_pll_slave_agent:rf_source_ready
	wire          sample_clk_pll_slave_agent_rf_source_startofpacket;                                 // sample_clk_pll_slave_agent:rf_source_startofpacket -> sample_clk_pll_slave_agent_rsp_fifo:in_startofpacket
	wire          sample_clk_pll_slave_agent_rf_source_endofpacket;                                   // sample_clk_pll_slave_agent:rf_source_endofpacket -> sample_clk_pll_slave_agent_rsp_fifo:in_endofpacket
	wire          sample_clk_pll_slave_agent_rsp_fifo_out_valid;                                      // sample_clk_pll_slave_agent_rsp_fifo:out_valid -> sample_clk_pll_slave_agent:rf_sink_valid
	wire  [107:0] sample_clk_pll_slave_agent_rsp_fifo_out_data;                                       // sample_clk_pll_slave_agent_rsp_fifo:out_data -> sample_clk_pll_slave_agent:rf_sink_data
	wire          sample_clk_pll_slave_agent_rsp_fifo_out_ready;                                      // sample_clk_pll_slave_agent:rf_sink_ready -> sample_clk_pll_slave_agent_rsp_fifo:out_ready
	wire          sample_clk_pll_slave_agent_rsp_fifo_out_startofpacket;                              // sample_clk_pll_slave_agent_rsp_fifo:out_startofpacket -> sample_clk_pll_slave_agent:rf_sink_startofpacket
	wire          sample_clk_pll_slave_agent_rsp_fifo_out_endofpacket;                                // sample_clk_pll_slave_agent_rsp_fifo:out_endofpacket -> sample_clk_pll_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> sample_clk_pll_slave_agent:cp_valid
	wire  [106:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sample_clk_pll_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                              // sample_clk_pll_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [9:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sample_clk_pll_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> sample_clk_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> sample_clk_pll_slave_agent:cp_endofpacket
	...
	wire    [9:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire    [9:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> sw_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // sw_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [9:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> sw_s1_agent:cp_channel
	...
	wire   [31:0] freq_s1_agent_m0_readdata;                                                          // freq_s1_translator:uav_readdata -> freq_s1_agent:m0_readdata
	wire          freq_s1_agent_m0_waitrequest;                                                       // freq_s1_translator:uav_waitrequest -> freq_s1_agent:m0_waitrequest
	wire          freq_s1_agent_m0_debugaccess;                                                       // freq_s1_agent:m0_debugaccess -> freq_s1_translator:uav_debugaccess
	wire   [28:0] freq_s1_agent_m0_address;                                                           // freq_s1_agent:m0_address -> freq_s1_translator:uav_address
	wire    [3:0] freq_s1_agent_m0_byteenable;                                                        // freq_s1_agent:m0_byteenable -> freq_s1_translator:uav_byteenable
	wire          freq_s1_agent_m0_read;                                                              // freq_s1_agent:m0_read -> freq_s1_translator:uav_read
	wire          freq_s1_agent_m0_readdatavalid;                                                     // freq_s1_translator:uav_readdatavalid -> freq_s1_agent:m0_readdatavalid
	wire          freq_s1_agent_m0_lock;                                                              // freq_s1_agent:m0_lock -> freq_s1_translator:uav_lock
	wire   [31:0] freq_s1_agent_m0_writedata;                                                         // freq_s1_agent:m0_writedata -> freq_s1_translator:uav_writedata
	wire          freq_s1_agent_m0_write;                                                             // freq_s1_agent:m0_write -> freq_s1_translator:uav_write
	wire    [2:0] freq_s1_agent_m0_burstcount;                                                        // freq_s1_agent:m0_burstcount -> freq_s1_translator:uav_burstcount
	wire          freq_s1_agent_rf_source_valid;                                                      // freq_s1_agent:rf_source_valid -> freq_s1_agent_rsp_fifo:in_valid
	wire  [107:0] freq_s1_agent_rf_source_data;                                                       // freq_s1_agent:rf_source_data -> freq_s1_agent_rsp_fifo:in_data
	wire          freq_s1_agent_rf_source_ready;                                                      // freq_s1_agent_rsp_fifo:in_ready -> freq_s1_agent:rf_source_ready
	wire          freq_s1_agent_rf_source_startofpacket;                                              // freq_s1_agent:rf_source_startofpacket -> freq_s1_agent_rsp_fifo:in_startofpacket
	wire          freq_s1_agent_rf_source_endofpacket;                                                // freq_s1_agent:rf_source_endofpacket -> freq_s1_agent_rsp_fifo:in_endofpacket
	wire          freq_s1_agent_rsp_fifo_out_valid;                                                   // freq_s1_agent_rsp_fifo:out_valid -> freq_s1_agent:rf_sink_valid
	wire  [107:0] freq_s1_agent_rsp_fifo_out_data;                                                    // freq_s1_agent_rsp_fifo:out_data -> freq_s1_agent:rf_sink_data
	wire          freq_s1_agent_rsp_fifo_out_ready;                                                   // freq_s1_agent:rf_sink_ready -> freq_s1_agent_rsp_fifo:out_ready
	wire          freq_s1_agent_rsp_fifo_out_startofpacket;                                           // freq_s1_agent_rsp_fifo:out_startofpacket -> freq_s1_agent:rf_sink_startofpacket
	wire          freq_s1_agent_rsp_fifo_out_endofpacket;                                             // freq_s1_agent_rsp_fifo:out_endofpacket -> freq_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> freq_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> freq_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // freq_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [9:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> freq_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> freq_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> freq_s1_agent:cp_endofpacket
	wire   [31:0] amp_s1_agent_m0_readdata;                                                           // amp_s1_translator:uav_readdata -> amp_s1_agent:m0_readdata
	wire          amp_s1_agent_m0_waitrequest;                                                        // amp_s1_translator:uav_waitrequest -> amp_s1_agent:m0_waitrequest
	wire          amp_s1_agent_m0_debugaccess;                                                        // amp_s1_agent:m0_debugaccess -> amp_s1_translator:uav_debugaccess
	wire   [28:0] amp_s1_agent_m0_address;                                                            // amp_s1_agent:m0_address -> amp_s1_translator:uav_address
	wire    [3:0] amp_s1_agent_m0_byteenable;                                                         // amp_s1_agent:m0_byteenable -> amp_s1_translator:uav_byteenable
	wire          amp_s1_agent_m0_read;                                                               // amp_s1_agent:m0_read -> amp_s1_translator:uav_read
	wire          amp_s1_agent_m0_readdatavalid;                                                      // amp_s1_translator:uav_readdatavalid -> amp_s1_agent:m0_readdatavalid
	wire          amp_s1_agent_m0_lock;                                                               // amp_s1_agent:m0_lock -> amp_s1_translator:uav_lock
	wire   [31:0] amp_s1_agent_m0_writedata;                                                          // amp_s1_agent:m0_writedata -> amp_s1_translator:uav_writedata
	wire          amp_s1_agent_m0_write;                                                              // amp_s1_agent:m0_write -> amp_s1_translator:uav_write
	wire    [2:0] amp_s1_agent_m0_burstcount;                                                         // amp_s1_agent:m0_burstcount -> amp_s1_translator:uav_burstcount
	wire          amp_s1_agent_rf_source_valid;                                                       // amp_s1_agent:rf_source_valid -> amp_s1_agent_rsp_fifo:in_valid
	wire  [107:0] amp_s1_agent_rf_source_data;                                                        // amp_s1_agent:rf_source_data -> amp_s1_agent_rsp_fifo:in_data
	wire          amp_s1_agent_rf_source_ready;                                                       // amp_s1_agent_rsp_fifo:in_ready -> amp_s1_agent:rf_source_ready
	wire          amp_s1_agent_rf_source_startofpacket;                                               // amp_s1_agent:rf_source_startofpacket -> amp_s1_agent_rsp_fifo:in_startofpacket
	wire          amp_s1_agent_rf_source_endofpacket;                                                 // amp_s1_agent:rf_source_endofpacket -> amp_s1_agent_rsp_fifo:in_endofpacket
	wire          amp_s1_agent_rsp_fifo_out_valid;                                                    // amp_s1_agent_rsp_fifo:out_valid -> amp_s1_agent:rf_sink_valid
	wire  [107:0] amp_s1_agent_rsp_fifo_out_data;                                                     // amp_s1_agent_rsp_fifo:out_data -> amp_s1_agent:rf_sink_data
	wire          amp_s1_agent_rsp_fifo_out_ready;                                                    // amp_s1_agent:rf_sink_ready -> amp_s1_agent_rsp_fifo:out_ready
	wire          amp_s1_agent_rsp_fifo_out_startofpacket;                                            // amp_s1_agent_rsp_fifo:out_startofpacket -> amp_s1_agent:rf_sink_startofpacket
	wire          amp_s1_agent_rsp_fifo_out_endofpacket;                                              // amp_s1_agent_rsp_fifo:out_endofpacket -> amp_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> amp_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> amp_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // amp_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [9:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> amp_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> amp_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> amp_s1_agent:cp_endofpacket
	...
	wire    [9:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> sdram_s1_agent:cp_channel
	...
	wire    [9:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> led_s1_agent:cp_channel
	...
	wire          sample_clk_pll_slave_agent_rp_valid;                                                // sample_clk_pll_slave_agent:rp_valid -> router_004:sink_valid
	wire  [106:0] sample_clk_pll_slave_agent_rp_data;                                                 // sample_clk_pll_slave_agent:rp_data -> router_004:sink_data
	wire          sample_clk_pll_slave_agent_rp_ready;                                                // router_004:sink_ready -> sample_clk_pll_slave_agent:rp_ready
	wire          sample_clk_pll_slave_agent_rp_startofpacket;                                        // sample_clk_pll_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          sample_clk_pll_slave_agent_rp_endofpacket;                                          // sample_clk_pll_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [106:0] sw_s1_agent_rp_data;                                                                // sw_s1_agent:rp_data -> router_007:sink_data
	...
	wire          freq_s1_agent_rp_valid;                                                             // freq_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] freq_s1_agent_rp_data;                                                              // freq_s1_agent:rp_data -> router_008:sink_data
	wire          freq_s1_agent_rp_ready;                                                             // router_008:sink_ready -> freq_s1_agent:rp_ready
	wire          freq_s1_agent_rp_startofpacket;                                                     // freq_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          freq_s1_agent_rp_endofpacket;                                                       // freq_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          amp_s1_agent_rp_valid;                                                              // amp_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] amp_s1_agent_rp_data;                                                               // amp_s1_agent:rp_data -> router_009:sink_data
	wire          amp_s1_agent_rp_ready;                                                              // router_009:sink_ready -> amp_s1_agent:rp_ready
	wire          amp_s1_agent_rp_startofpacket;                                                      // amp_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          amp_s1_agent_rp_endofpacket;                                                        // amp_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire    [9:0] cmd_demux_src8_channel;                                                             // cmd_demux:src8_channel -> crosser:in_channel
	...
	wire    [9:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_008:sink0_channel
	...
	wire  [106:0] cmd_demux_001_src8_data;                                                            // cmd_demux_001:src8_data -> crosser_001:in_data
	wire          cmd_demux_001_src8_ready;                                                           // crosser_001:in_ready -> cmd_demux_001:src8_ready
	wire    [9:0] cmd_demux_001_src8_channel;                                                         // cmd_demux_001:src8_channel -> crosser_001:in_channel
	...
	wire  [106:0] crosser_001_out_data;                                                               // crosser_001:out_data -> cmd_mux_008:sink1_data
	wire          crosser_001_out_ready;                                                              // cmd_mux_008:sink1_ready -> crosser_001:out_ready
	wire    [9:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_008:sink1_channel
	...
	wire  [106:0] rsp_demux_008_src0_data;                                                            // rsp_demux_008:src0_data -> crosser_002:in_data
	wire          rsp_demux_008_src0_ready;                                                           // crosser_002:in_ready -> rsp_demux_008:src0_ready
	wire    [9:0] rsp_demux_008_src0_channel;                                                         // rsp_demux_008:src0_channel -> crosser_002:in_channel
	...
	wire          crosser_002_out_valid;                                                              // crosser_002:out_valid -> rsp_mux:sink8_valid
	wire  [106:0] crosser_002_out_data;                                                               // crosser_002:out_data -> rsp_mux:sink8_data
	wire          crosser_002_out_ready;                                                              // rsp_mux:sink8_ready -> crosser_002:out_ready
	wire    [9:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink8_channel
	wire          crosser_002_out_startofpacket;                                                      // crosser_002:out_startofpacket -> rsp_mux:sink8_startofpacket
	wire          crosser_002_out_endofpacket;                                                        // crosser_002:out_endofpacket -> rsp_mux:sink8_endofpacket
	wire          rsp_demux_008_src1_valid;                                                           // rsp_demux_008:src1_valid -> crosser_003:in_valid
	wire  [106:0] rsp_demux_008_src1_data;                                                            // rsp_demux_008:src1_data -> crosser_003:in_data
	wire          rsp_demux_008_src1_ready;                                                           // crosser_003:in_ready -> rsp_demux_008:src1_ready
	wire    [9:0] rsp_demux_008_src1_channel;                                                         // rsp_demux_008:src1_channel -> crosser_003:in_channel
	...
	wire          crosser_003_out_valid;                                                              // crosser_003:out_valid -> rsp_mux_001:sink8_valid
	wire  [106:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink8_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink8_ready -> crosser_003:out_ready
	wire    [9:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink8_channel
	wire          crosser_003_out_startofpacket;                                                      // crosser_003:out_startofpacket -> rsp_mux_001:sink8_startofpacket
	wire          crosser_003_out_endofpacket;                                                        // crosser_003:out_endofpacket -> rsp_mux_001:sink8_endofpacket
	...
	wire          sample_clk_pll_slave_agent_rdata_fifo_src_valid;                                    // sample_clk_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] sample_clk_pll_slave_agent_rdata_fifo_src_data;                                     // sample_clk_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          sample_clk_pll_slave_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_002:in_0_ready -> sample_clk_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                                  // avalon_st_adapter_002:out_0_valid -> sample_clk_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                                   // avalon_st_adapter_002:out_0_data -> sample_clk_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                                  // sample_clk_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                                  // avalon_st_adapter_002:out_0_error -> sample_clk_pll_slave_agent:rdata_fifo_sink_error
	...
	wire          freq_s1_agent_rdata_fifo_src_valid;                                                 // freq_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] freq_s1_agent_rdata_fifo_src_data;                                                  // freq_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          freq_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_006:in_0_ready -> freq_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> freq_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> freq_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // freq_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> freq_s1_agent:rdata_fifo_sink_error
	wire          amp_s1_agent_rdata_fifo_src_valid;                                                  // amp_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] amp_s1_agent_rdata_fifo_src_data;                                                   // amp_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          amp_s1_agent_rdata_fifo_src_ready;                                                  // avalon_st_adapter_007:in_0_ready -> amp_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> amp_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> amp_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // amp_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> amp_s1_agent:rdata_fifo_sink_error
	wire          sdram_s1_agent_rdata_fifo_out_valid;                                                // sdram_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] sdram_s1_agent_rdata_fifo_out_data;                                                 // sdram_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_008:in_0_data
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sample_clk_pll_slave_translator (
		.clk                    (clk_0_clk_clk),                                                //                      clk.clk
		.reset                  (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sample_clk_pll_slave_agent_m0_address),                        // avalon_universal_slave_0.address
		.uav_burstcount         (sample_clk_pll_slave_agent_m0_burstcount),                     //                         .burstcount
		.uav_read               (sample_clk_pll_slave_agent_m0_read),                           //                         .read
		.uav_write              (sample_clk_pll_slave_agent_m0_write),                          //                         .write
		.uav_waitrequest        (sample_clk_pll_slave_agent_m0_waitrequest),                    //                         .waitrequest
		.uav_readdatavalid      (sample_clk_pll_slave_agent_m0_readdatavalid),                  //                         .readdatavalid
		.uav_byteenable         (sample_clk_pll_slave_agent_m0_byteenable),                     //                         .byteenable
		.uav_readdata           (sample_clk_pll_slave_agent_m0_readdata),                       //                         .readdata
		.uav_writedata          (sample_clk_pll_slave_agent_m0_writedata),                      //                         .writedata
		.uav_lock               (sample_clk_pll_slave_agent_m0_lock),                           //                         .lock
		.uav_debugaccess        (sample_clk_pll_slave_agent_m0_debugaccess),                    //                         .debugaccess
		.av_address             (sample_clk_pll_slave_address),                                 //      avalon_anti_slave_0.address
		.av_write               (sample_clk_pll_slave_write),                                   //                         .write
		.av_read                (sample_clk_pll_slave_read),                                    //                         .read
		.av_readdata            (sample_clk_pll_slave_readdata),                                //                         .readdata
		.av_writedata           (sample_clk_pll_slave_writedata),                               //                         .writedata
		.av_begintransfer       (),                                                             //              (terminated)
		.av_beginbursttransfer  (),                                                             //              (terminated)
		.av_burstcount          (),                                                             //              (terminated)
		.av_byteenable          (),                                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                                //                      clk.clk
		.reset                  (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (freq_s1_agent_m0_address),                                     // avalon_universal_slave_0.address
		.uav_burstcount         (freq_s1_agent_m0_burstcount),                                  //                         .burstcount
		.uav_read               (freq_s1_agent_m0_read),                                        //                         .read
		.uav_write              (freq_s1_agent_m0_write),                                       //                         .write
		.uav_waitrequest        (freq_s1_agent_m0_waitrequest),                                 //                         .waitrequest
		.uav_readdatavalid      (freq_s1_agent_m0_readdatavalid),                               //                         .readdatavalid
		.uav_byteenable         (freq_s1_agent_m0_byteenable),                                  //                         .byteenable
		.uav_readdata           (freq_s1_agent_m0_readdata),                                    //                         .readdata
		.uav_writedata          (freq_s1_agent_m0_writedata),                                   //                         .writedata
		.uav_lock               (freq_s1_agent_m0_lock),                                        //                         .lock
		.uav_debugaccess        (freq_s1_agent_m0_debugaccess),                                 //                         .debugaccess
		.av_address             (freq_s1_address),                                              //      avalon_anti_slave_0.address
		.av_write               (freq_s1_write),                                                //                         .write
		.av_readdata            (freq_s1_readdata),                                             //                         .readdata
		.av_writedata           (freq_s1_writedata),                                            //                         .writedata
		.av_chipselect          (freq_s1_chipselect),                                           //                         .chipselect
		.av_read                (),                                                             //              (terminated)
		.av_begintransfer       (),                                                             //              (terminated)
		.av_beginbursttransfer  (),                                                             //              (terminated)
		.av_burstcount          (),                                                             //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                                //                      clk.clk
		.reset                  (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (amp_s1_agent_m0_address),                                      // avalon_universal_slave_0.address
		.uav_burstcount         (amp_s1_agent_m0_burstcount),                                   //                         .burstcount
		.uav_read               (amp_s1_agent_m0_read),                                         //                         .read
		.uav_write              (amp_s1_agent_m0_write),                                        //                         .write
		.uav_waitrequest        (amp_s1_agent_m0_waitrequest),                                  //                         .waitrequest
		.uav_readdatavalid      (amp_s1_agent_m0_readdatavalid),                                //                         .readdatavalid
		.uav_byteenable         (amp_s1_agent_m0_byteenable),                                   //                         .byteenable
		.uav_readdata           (amp_s1_agent_m0_readdata),                                     //                         .readdata
		.uav_writedata          (amp_s1_agent_m0_writedata),                                    //                         .writedata
		.uav_lock               (amp_s1_agent_m0_lock),                                         //                         .lock
		.uav_debugaccess        (amp_s1_agent_m0_debugaccess),                                  //                         .debugaccess
		.av_address             (amp_s1_address),                                               //      avalon_anti_slave_0.address
		.av_write               (amp_s1_write),                                                 //                         .write
		.av_readdata            (amp_s1_readdata),                                              //                         .readdata
		.av_writedata           (amp_s1_writedata),                                             //                         .writedata
		.av_chipselect          (amp_s1_chipselect),                                            //                         .chipselect
		.av_read                (),                                                             //              (terminated)
		.av_begintransfer       (),                                                             //              (terminated)
		.av_beginbursttransfer  (),                                                             //              (terminated)
		.av_burstcount          (),                                                             //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sample_clk_pll_slave_agent (
		.clk                     (clk_0_clk_clk),                                                //             clk.clk
		.reset                   (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (sample_clk_pll_slave_agent_m0_address),                        //              m0.address
		.m0_burstcount           (sample_clk_pll_slave_agent_m0_burstcount),                     //                .burstcount
		.m0_byteenable           (sample_clk_pll_slave_agent_m0_byteenable),                     //                .byteenable
		.m0_debugaccess          (sample_clk_pll_slave_agent_m0_debugaccess),                    //                .debugaccess
		.m0_lock                 (sample_clk_pll_slave_agent_m0_lock),                           //                .lock
		.m0_readdata             (sample_clk_pll_slave_agent_m0_readdata),                       //                .readdata
		.m0_readdatavalid        (sample_clk_pll_slave_agent_m0_readdatavalid),                  //                .readdatavalid
		.m0_read                 (sample_clk_pll_slave_agent_m0_read),                           //                .read
		.m0_waitrequest          (sample_clk_pll_slave_agent_m0_waitrequest),                    //                .waitrequest
		.m0_writedata            (sample_clk_pll_slave_agent_m0_writedata),                      //                .writedata
		.m0_write                (sample_clk_pll_slave_agent_m0_write),                          //                .write
		.rp_endofpacket          (sample_clk_pll_slave_agent_rp_endofpacket),                    //              rp.endofpacket
		.rp_ready                (sample_clk_pll_slave_agent_rp_ready),                          //                .ready
		.rp_valid                (sample_clk_pll_slave_agent_rp_valid),                          //                .valid
		.rp_data                 (sample_clk_pll_slave_agent_rp_data),                           //                .data
		.rp_startofpacket        (sample_clk_pll_slave_agent_rp_startofpacket),                  //                .startofpacket
		...
		.rf_sink_ready           (sample_clk_pll_slave_agent_rsp_fifo_out_ready),                //         rf_sink.ready
		.rf_sink_valid           (sample_clk_pll_slave_agent_rsp_fifo_out_valid),                //                .valid
		.rf_sink_startofpacket   (sample_clk_pll_slave_agent_rsp_fifo_out_startofpacket),        //                .startofpacket
		.rf_sink_endofpacket     (sample_clk_pll_slave_agent_rsp_fifo_out_endofpacket),          //                .endofpacket
		.rf_sink_data            (sample_clk_pll_slave_agent_rsp_fifo_out_data),                 //                .data
		.rf_source_ready         (sample_clk_pll_slave_agent_rf_source_ready),                   //       rf_source.ready
		.rf_source_valid         (sample_clk_pll_slave_agent_rf_source_valid),                   //                .valid
		.rf_source_startofpacket (sample_clk_pll_slave_agent_rf_source_startofpacket),           //                .startofpacket
		.rf_source_endofpacket   (sample_clk_pll_slave_agent_rf_source_endofpacket),             //                .endofpacket
		.rf_source_data          (sample_clk_pll_slave_agent_rf_source_data),                    //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (sample_clk_pll_slave_agent_rdata_fifo_src_ready),              //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sample_clk_pll_slave_agent_rdata_fifo_src_valid),              //                .valid
		.rdata_fifo_src_data     (sample_clk_pll_slave_agent_rdata_fifo_src_data),               //                .data
		.m0_response             (2'b00),                                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sample_clk_pll_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                //       clk.clk
		.reset             (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sample_clk_pll_slave_agent_rf_source_data),                    //        in.data
		.in_valid          (sample_clk_pll_slave_agent_rf_source_valid),                   //          .valid
		.in_ready          (sample_clk_pll_slave_agent_rf_source_ready),                   //          .ready
		.in_startofpacket  (sample_clk_pll_slave_agent_rf_source_startofpacket),           //          .startofpacket
		.in_endofpacket    (sample_clk_pll_slave_agent_rf_source_endofpacket),             //          .endofpacket
		.out_data          (sample_clk_pll_slave_agent_rsp_fifo_out_data),                 //       out.data
		.out_valid         (sample_clk_pll_slave_agent_rsp_fifo_out_valid),                //          .valid
		.out_ready         (sample_clk_pll_slave_agent_rsp_fifo_out_ready),                //          .ready
		.out_startofpacket (sample_clk_pll_slave_agent_rsp_fifo_out_startofpacket),        //          .startofpacket
		.out_endofpacket   (sample_clk_pll_slave_agent_rsp_fifo_out_endofpacket),          //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                                //             clk.clk
		.reset                   (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (freq_s1_agent_m0_address),                                     //              m0.address
		.m0_burstcount           (freq_s1_agent_m0_burstcount),                                  //                .burstcount
		.m0_byteenable           (freq_s1_agent_m0_byteenable),                                  //                .byteenable
		.m0_debugaccess          (freq_s1_agent_m0_debugaccess),                                 //                .debugaccess
		.m0_lock                 (freq_s1_agent_m0_lock),                                        //                .lock
		.m0_readdata             (freq_s1_agent_m0_readdata),                                    //                .readdata
		.m0_readdatavalid        (freq_s1_agent_m0_readdatavalid),                               //                .readdatavalid
		.m0_read                 (freq_s1_agent_m0_read),                                        //                .read
		.m0_waitrequest          (freq_s1_agent_m0_waitrequest),                                 //                .waitrequest
		.m0_writedata            (freq_s1_agent_m0_writedata),                                   //                .writedata
		.m0_write                (freq_s1_agent_m0_write),                                       //                .write
		.rp_endofpacket          (freq_s1_agent_rp_endofpacket),                                 //              rp.endofpacket
		.rp_ready                (freq_s1_agent_rp_ready),                                       //                .ready
		.rp_valid                (freq_s1_agent_rp_valid),                                       //                .valid
		.rp_data                 (freq_s1_agent_rp_data),                                        //                .data
		.rp_startofpacket        (freq_s1_agent_rp_startofpacket),                               //                .startofpacket
		...
		.rf_sink_ready           (freq_s1_agent_rsp_fifo_out_ready),                             //         rf_sink.ready
		.rf_sink_valid           (freq_s1_agent_rsp_fifo_out_valid),                             //                .valid
		.rf_sink_startofpacket   (freq_s1_agent_rsp_fifo_out_startofpacket),                     //                .startofpacket
		.rf_sink_endofpacket     (freq_s1_agent_rsp_fifo_out_endofpacket),                       //                .endofpacket
		.rf_sink_data            (freq_s1_agent_rsp_fifo_out_data),                              //                .data
		.rf_source_ready         (freq_s1_agent_rf_source_ready),                                //       rf_source.ready
		.rf_source_valid         (freq_s1_agent_rf_source_valid),                                //                .valid
		.rf_source_startofpacket (freq_s1_agent_rf_source_startofpacket),                        //                .startofpacket
		.rf_source_endofpacket   (freq_s1_agent_rf_source_endofpacket),                          //                .endofpacket
		.rf_source_data          (freq_s1_agent_rf_source_data),                                 //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (freq_s1_agent_rdata_fifo_src_ready),                           //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (freq_s1_agent_rdata_fifo_src_valid),                           //                .valid
		.rdata_fifo_src_data     (freq_s1_agent_rdata_fifo_src_data),                            //                .data
		.m0_response             (2'b00),                                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) freq_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                //       clk.clk
		.reset             (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (freq_s1_agent_rf_source_data),                                 //        in.data
		.in_valid          (freq_s1_agent_rf_source_valid),                                //          .valid
		.in_ready          (freq_s1_agent_rf_source_ready),                                //          .ready
		.in_startofpacket  (freq_s1_agent_rf_source_startofpacket),                        //          .startofpacket
		.in_endofpacket    (freq_s1_agent_rf_source_endofpacket),                          //          .endofpacket
		.out_data          (freq_s1_agent_rsp_fifo_out_data),                              //       out.data
		.out_valid         (freq_s1_agent_rsp_fifo_out_valid),                             //          .valid
		.out_ready         (freq_s1_agent_rsp_fifo_out_ready),                             //          .ready
		.out_startofpacket (freq_s1_agent_rsp_fifo_out_startofpacket),                     //          .startofpacket
		.out_endofpacket   (freq_s1_agent_rsp_fifo_out_endofpacket),                       //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                                //             clk.clk
		.reset                   (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (amp_s1_agent_m0_address),                                      //              m0.address
		.m0_burstcount           (amp_s1_agent_m0_burstcount),                                   //                .burstcount
		.m0_byteenable           (amp_s1_agent_m0_byteenable),                                   //                .byteenable
		.m0_debugaccess          (amp_s1_agent_m0_debugaccess),                                  //                .debugaccess
		.m0_lock                 (amp_s1_agent_m0_lock),                                         //                .lock
		.m0_readdata             (amp_s1_agent_m0_readdata),                                     //                .readdata
		.m0_readdatavalid        (amp_s1_agent_m0_readdatavalid),                                //                .readdatavalid
		.m0_read                 (amp_s1_agent_m0_read),                                         //                .read
		.m0_waitrequest          (amp_s1_agent_m0_waitrequest),                                  //                .waitrequest
		.m0_writedata            (amp_s1_agent_m0_writedata),                                    //                .writedata
		.m0_write                (amp_s1_agent_m0_write),                                        //                .write
		.rp_endofpacket          (amp_s1_agent_rp_endofpacket),                                  //              rp.endofpacket
		.rp_ready                (amp_s1_agent_rp_ready),                                        //                .ready
		.rp_valid                (amp_s1_agent_rp_valid),                                        //                .valid
		.rp_data                 (amp_s1_agent_rp_data),                                         //                .data
		.rp_startofpacket        (amp_s1_agent_rp_startofpacket),                                //                .startofpacket
		...
		.rf_sink_ready           (amp_s1_agent_rsp_fifo_out_ready),                              //         rf_sink.ready
		.rf_sink_valid           (amp_s1_agent_rsp_fifo_out_valid),                              //                .valid
		.rf_sink_startofpacket   (amp_s1_agent_rsp_fifo_out_startofpacket),                      //                .startofpacket
		.rf_sink_endofpacket     (amp_s1_agent_rsp_fifo_out_endofpacket),                        //                .endofpacket
		.rf_sink_data            (amp_s1_agent_rsp_fifo_out_data),                               //                .data
		.rf_source_ready         (amp_s1_agent_rf_source_ready),                                 //       rf_source.ready
		.rf_source_valid         (amp_s1_agent_rf_source_valid),                                 //                .valid
		.rf_source_startofpacket (amp_s1_agent_rf_source_startofpacket),                         //                .startofpacket
		.rf_source_endofpacket   (amp_s1_agent_rf_source_endofpacket),                           //                .endofpacket
		.rf_source_data          (amp_s1_agent_rf_source_data),                                  //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (amp_s1_agent_rdata_fifo_src_ready),                            //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (amp_s1_agent_rdata_fifo_src_valid),                            //                .valid
		.rdata_fifo_src_data     (amp_s1_agent_rdata_fifo_src_data),                             //                .data
		.m0_response             (2'b00),                                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) amp_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                                //       clk.clk
		.reset             (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (amp_s1_agent_rf_source_data),                                  //        in.data
		.in_valid          (amp_s1_agent_rf_source_valid),                                 //          .valid
		.in_ready          (amp_s1_agent_rf_source_ready),                                 //          .ready
		.in_startofpacket  (amp_s1_agent_rf_source_startofpacket),                         //          .startofpacket
		.in_endofpacket    (amp_s1_agent_rf_source_endofpacket),                           //          .endofpacket
		.out_data          (amp_s1_agent_rsp_fifo_out_data),                               //       out.data
		.out_valid         (amp_s1_agent_rsp_fifo_out_valid),                              //          .valid
		.out_ready         (amp_s1_agent_rsp_fifo_out_ready),                              //          .ready
		.out_startofpacket (amp_s1_agent_rsp_fifo_out_startofpacket),                      //          .startofpacket
		.out_endofpacket   (amp_s1_agent_rsp_fifo_out_endofpacket),                        //          .endofpacket
		.csr_address       (2'b00),                                                        // (terminated)
		.csr_read          (1'b0),                                                         // (terminated)
		.csr_write         (1'b0),                                                         // (terminated)
		.csr_readdata      (),                                                             // (terminated)
	...
	soc_mm_interconnect_0_router router_001 (
	...
	soc_mm_interconnect_0_router_002 router_003 (
	...
	soc_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (sample_clk_pll_slave_agent_rp_ready),                          //      sink.ready
		.sink_valid         (sample_clk_pll_slave_agent_rp_valid),                          //          .valid
		.sink_data          (sample_clk_pll_slave_agent_rp_data),                           //          .data
		.sink_startofpacket (sample_clk_pll_slave_agent_rp_startofpacket),                  //          .startofpacket
		.sink_endofpacket   (sample_clk_pll_slave_agent_rp_endofpacket),                    //          .endofpacket
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_router_002 router_005 (
	...
	soc_mm_interconnect_0_router_002 router_007 (
	...
	soc_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (freq_s1_agent_rp_ready),                                       //      sink.ready
		.sink_valid         (freq_s1_agent_rp_valid),                                       //          .valid
		.sink_data          (freq_s1_agent_rp_data),                                        //          .data
		.sink_startofpacket (freq_s1_agent_rp_startofpacket),                               //          .startofpacket
		.sink_endofpacket   (freq_s1_agent_rp_endofpacket),                                 //          .endofpacket
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (amp_s1_agent_rp_ready),                                        //      sink.ready
		.sink_valid         (amp_s1_agent_rp_valid),                                        //          .valid
		.sink_data          (amp_s1_agent_rp_data),                                         //          .data
		.sink_startofpacket (amp_s1_agent_rp_startofpacket),                                //          .startofpacket
		.sink_endofpacket   (amp_s1_agent_rp_endofpacket),                                  //          .endofpacket
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_router_002 router_010 (
	...
	soc_mm_interconnect_0_router_002 router_011 (
	...
	soc_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                                //       clk.clk
		.reset               (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                                //       clk.clk
		.reset               (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                                //       clk.clk
		.reset               (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                                //       clk.clk
		.reset               (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_cmd_mux cmd_mux_009 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                                //       clk.clk
		.reset              (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                                // in_clk_0.clk
		.in_rst_0_reset (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sample_clk_pll_slave_agent_rdata_fifo_src_data),               //     in_0.data
		.in_0_valid     (sample_clk_pll_slave_agent_rdata_fifo_src_valid),              //         .valid
		.in_0_ready     (sample_clk_pll_slave_agent_rdata_fifo_src_ready),              //         .ready
	...
	soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                                // in_clk_0.clk
		.in_rst_0_reset (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (freq_s1_agent_rdata_fifo_src_data),                            //     in_0.data
		.in_0_valid     (freq_s1_agent_rdata_fifo_src_valid),                           //         .valid
		.in_0_ready     (freq_s1_agent_rdata_fifo_src_ready),                           //         .ready
	...
	soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                                // in_clk_0.clk
		.in_rst_0_reset (sample_clk_inclk_interface_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (amp_s1_agent_rdata_fifo_src_data),                             //     in_0.data
		.in_0_valid     (amp_s1_agent_rdata_fifo_src_valid),                            //         .valid
		.in_0_ready     (amp_s1_agent_rdata_fifo_src_ready),                            //         .ready
